<html>
	<?php
		...
		//Declaracion Query
		$SelectQuery = "SELECT * FROM coordinador where Usuario='$Username' AND Contrasena='$EncryptedPassword'";
		...
		if($CodigoError == 3){
			...
			if(!$UserExist){
				...
				$_SESSION['CoordinadorID'] = $UserExist['DNI'];
				if($_SESSION['CoordinadorID'])
	...
	<body background='../System/1sa.jpg'>
		...
		<div class="DivBox2">
			...
			<p id="LoginTitle">Iniciar sesión como coordinador</p>
				<?php
